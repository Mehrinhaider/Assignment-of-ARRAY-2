...
const products:Product[]=[
    {
    ...
    },
     {
       ...
       function changeColour(products: Product, newColour:string){
...
else {console.log(`sorry! this ${newColour} is not available`)};

       }
function displayProductDetail (products:Product[]):void{
